...
/// Extension for [LatLng] to add custom operators and methods. packages/animated_marker
extension LatLngExt on LatLng {
  ...
  LatLng leap(LatLng other, {required double step}) {
...
extension IntExtension on double {
  ...
  /// [step] should be a value between 0.0 and 1.0 (inclusive).
  double leap(double angle, {required double step}) {
    assert(step >= 0.0 && step <= 1.0);
