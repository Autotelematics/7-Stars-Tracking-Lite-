...
import 'package:autotelematic_new_app/utils/extensions.dart';
import 'package:flutter/material.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';

/// A widget that animates a set of [Marker]s on a [GoogleMap].
///packages/animated_marker
  ...
  void didUpdateWidget(covariant AnimatedMarker oldWidget) {
    ...
    _tickerTimer = Timer.periodic(_animationInterval, (timer) {
      ...
      for (final markerPair in updatedMarkerPairs.entries) {
        ...
        final newLatLng = oldPosition.leap(newPosition, step: curveFraction);
        final newRotation =
            oldMarker.rotation.leap(newMarker.rotation, step: curveFraction);
